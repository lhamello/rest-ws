...
public class EletrodomesticoRest implements Serializable {
    ...
    @Path("eletrodomestico/{id:[0-9][0-9]*}")
    @PUT
    @TransactionAttribute(TransactionAttributeType.REQUIRED)
    public Response atualizar(@PathParam("id") Long id, final Eletrodomestico produto) {
        ...
        try {
            Eletrodomestico obj = eletrodomesticoService.consultarChave(id);
            ...
            if (obj == null) {
                ...
                retorno = eletrodomesticoService.alterar(produto);
            }
