...
public class ComputadorRest implements Serializable {
    ...
    public Response atualizar(@PathParam("id") Long id, final Computador produto) {
        ...
        try {
            Computador obj = computadorService.consultarChave(id);
            ...
            if (obj == null) {
                ...
                retorno = computadorService.alterar(produto);
            }
    ...
    public Response incluir(final Computador computador) {
        ...
        try {
            if (computador.getDataHoraInclusao() != null || computador.getDataHoraUltimaAlteracao() != null) {
                mensagem = new StringBuilder();
                mensagem.append("Campos de controle (dataHoraInclusao, dataHoraUltimaAlteracao) não devem ser informados manualmente no arquivo json.");
